#!/usr/bin/env -S docker image build . --tag randomwordbot --file
...
LABEL org.opencontainers.image.authors="Chris Post <admin@postfmly.com>" \
  org.opencontainers.image.description="RandomWordBot for Discord" \
  org.opencontainers.image.licenses="GPL-3.0-only" \
  org.opencontainers.image.title="RandomWordBot" \
  org.opencontainers.image.url="https://github.com/chump29/randomwordbot"
